...
RUN set -x \
  && wget --auth-no-challenge --user=XDelphiGrl --password=${{secrets.XDELPHIGRL_JENKINS}} -O liquibase-4.4.0-DAT-6750-SNAPSHOT.tar.gz "https://jenkins.datical.net/job/liquibase-pro/job/DAT-6750/75/artifact/liquibase/liquibase-dist/target/liquibase-4.4.0-DAT-6750-SNAPSHOT.tar.gz" \
